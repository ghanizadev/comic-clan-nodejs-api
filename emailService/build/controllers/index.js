...
exports.default = {
    welcome: function (email, name, link, dashboard) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, emailSender.sendWelcomeAlert(email, {
                            name: name,
                            link: link,
                            dashboard: dashboard
                        })];
    ...
    reset: function (email, name, link) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, emailSender.sendResetAlert(email, {
                            name: name,
                            link: link,
                        })];
                    case 1:
    ...
    newMessage: function (email, name, postLink, from, message, postDate, profileLink) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, emailSender.sendMessageAlert(email, {
                            name: name,
                            postLink: postLink,
                            from: from,
                            message: message,
