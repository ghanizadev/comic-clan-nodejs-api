...
var EventHandler = /** @class */ (function () {
    ...
    EventHandler.prototype.retry_strategy = function (options) {
        if (options.attempt > 30) {
            logger_1.default.warn('Redis server is not responding...');
            process.exit(1);
        }
    ...
    EventHandler.prototype.connect = function (connectionString, channel) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                logger_1.default.info('Connecting to Redis server...');
                ...
                this.consumer.once('connect', function () {
                    logger_1.default.info('Consumer connected!');
                    logger_1.default.info("Subscribing to channel \"" + _this.channel + "\"...");
                    _this.consumer.subscribe(_this.channel);
                    _this.consumer.on('subscribe', function (ch) { return logger_1.default.info("Consumer subscribed to \"" + ch + "\""); });
                    _this.consumer.on('message', function (ch, msg) {
                        var decoded = JSON.parse(msg);
                        logger_1.default.info("Message received from \"" + decoded.from + "\"");
                        _this.eventListeners.forEach(function (event) {
                            if (decoded.event === event[0]) {
                                ...
                                event[1](decoded, function (response) {
                                    ...
                                    logger_1.default.info("Replying... [" + decoded.from + "]");
                                });
                            }
                        });
                    });
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (res, rej) {
                        try {
                            ...
                            var id_1 = uuid.v4();
                            logger_1.default.info("Publishing with id=" + id_1 + " to channel=" + channel);
                            _message.id = id_1;
